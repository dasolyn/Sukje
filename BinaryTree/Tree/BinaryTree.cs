...
namespace BinaryTree {
    ...
    public class BinaryTree<T> {
        ...
        // 이하의 트리 열거 메서드들은 성능 측면에서 문제가 있음이 파악되어 있습니다. (재귀 호출 안에서 yield를 쓰면 심각한 성능 저하가 발생)
        // 스택과 반복문을 사용해 성능 저하를 방지할수 있다는 걸 알고 있지만 새로 짤 시간도 없고
        // 어차피 학습용으로 짠거라서 지금 코드가 더 이해가 쉽다는 이유로 방치하기로 결정하였습니다. (2016/5/17 ANNA)
        /// <summary>
